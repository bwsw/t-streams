...
import com.bwsw.tstreamstransactionserver.netty.server.multiNode.handler.metadata.TransactionsPutHandler._
...
class TransactionsPutHandler(bookkeeperMaster: BookkeeperMaster,
