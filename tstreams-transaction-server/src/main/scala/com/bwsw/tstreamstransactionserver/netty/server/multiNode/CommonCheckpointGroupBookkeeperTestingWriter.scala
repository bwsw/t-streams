...
class CommonCheckpointGroupBookkeeperTestingWriter(zookeeperClient: CuratorFramework,
                                                   bookkeeperOptions: BookkeeperOptions,
                                                   commonPrefixesOptions: CommonPrefixesOptions,
                                                   compactionInterval: Long)
  extends CommonCheckpointGroupBookkeeperWriter(
    zookeeperClient,
    bookkeeperOptions,
    commonPrefixesOptions,
    compactionInterval) {

  def bookKeeperCompactionJob: BookKeeperCompactionJob = maybeCompactionJob.get
