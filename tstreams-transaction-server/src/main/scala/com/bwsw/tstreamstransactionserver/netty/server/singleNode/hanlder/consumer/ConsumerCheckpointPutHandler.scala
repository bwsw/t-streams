...
import com.bwsw.tstreamstransactionserver.netty.server.singleNode.hanlder.consumer.ConsumerCheckpointPutHandler._
...
class ConsumerCheckpointPutHandler(server: TransactionServer,
